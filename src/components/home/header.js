    ...
    <section className="header">
      ...
      <div className="header__content">
        <div className="all-content">
          ...
          <p className="lead">
            I am a software engineer / full-stack web developer based in East
            Africa <br /> specializing in building exceptional high
            <span>
              {" "}
              quality Websites, Web <br /> Applications and Rest APIs using
